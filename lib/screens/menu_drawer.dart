      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: Text('My Profile', style: TextStyle(color: kTextPrimary)),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            leading: Icon(Icons.shopping_cart_outlined, color: kPrimary),
            title: Text('Cart', style: TextStyle(color: kTextPrimary)),
            onTap: () {
              Navigator.pop(context);
          ...
          ListTile(
            ...
            title: Text('Settings', style: TextStyle(color: kTextPrimary)),
            onTap: () {
              Navigator.pop(context);
              Navigator.push(
                context,
          ...
          ListTile(
            ...
            title: Text('Logout', style: TextStyle(color: kTextPrimary)),
            onTap: () async {
              Navigator.pop(context);
